...
```{r Traffic Frustration,echo=FALSE,fig.align='center',out.width='50%'}
...
```{r Economics of Dynamic Pricing,echo=FALSE,fig.cap='("Out with the old, in with the new",2017)',fig.align='center',out.width='50%'}
